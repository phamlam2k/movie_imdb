      ...
      <div className='h-16 mt-[750px]'>
        <Section>
          ...
          <div className=' absolute top-[440px] left-[500px] min-w-[10px]'>
            <p className='text-xl text-[40px] line-camp-1 py-10'>
              {film.title}
            </p>
          ...
          >
            ...
            <div className='px-1 w-[80%]  overflow-hidden flex flex-col gap-3   '>
              <p className='text-lg truncate'>
                A screenplay synopsis is a vital tool in the filmmaking world,
                helping you sell your movie idea to agents, managers, producers,
                studio execs - basically anyone in Their journey is fraught with
                danger as they encounter ruthless scavengers and treacherous
                terrain. Along the way, Mia grapples with her guilt over leading
                Sam into danger and her fear of failing to protect him. As they
                near New Eden, Mia faces a moral dilemma when they stumble upon
                a group of refugees in desperate need of help. Risking their
                safety, Mia chooses compassion over self-preservation, earning
